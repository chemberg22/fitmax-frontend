...
async function fetchUserData() {
    ...
    try {
        ...
        if (userNameElement && userRoleElement && nomeCompletoElement && cpfElement && dataNascimentoElement && generoElement && emailElement && telefoneElement && enderecoElement && unidadeElement) {
            ...
            console.log('Elementos atualizados - Nome:', userNameElement.textContent, 'Perfil:', userRoleElement.textContent, 'Unidade:', unidadeElement.textContent);
        } else {
